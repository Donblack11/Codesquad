...
<!-- Header Begin -->
    ...
    <!-- Page Title Begin -->
    <section class="page-title-bg pt-250 pb-100" data-bg-img="assets/img/section-pattern/login.jpg">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="page-title text-center text-white">
                        ...
                        <ul class="list-inline">
                            <li><a href="index.html">Home</a></li>
                            <li><a href="marketer.php#marketer-signup">Log in</a></li>
    ...
    <section class="pt-120 pb-90 text-center">
        <div class="container">
            <div class="row">
               ...
               <div class="col-lg-6">
                   <div class="contact-form-wrapper">
                        <p>Enter the E-mail associated with your account, and we will send you a link to reset your password.</p>
                       <form method="POST" action="" class="contact-form">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <button type="submit" name="password" class="btn"><span>Reset Password</span></button>
            ...
            if (!$email) {
                ...
                $sel_query = "SELECT * FROM `marketer` WHERE email='".$email."'";
            ...
            // Insert Temp Table
            mysqli_query($con,
            "INSERT INTO `password_reset_temp` (`email`, `setkey`, `expDate`)
            VALUES ('".$email."', '".$key."', '".$expDate."');");

            $output='<p>Dear user,</p>';
            $output.='<p>Please click on the following link to reset your password.</p>';
            $output.='<p>-------------------------------------------------------------</p>';
            $output.='<p><a href="reset-password.php?key='.$key.'&email='.$email.'&action=reset" target="_blank">https://www.allphptricks.com/forgot-password/reset-password.php?key='.$key.'&email='.$email.'&action=reset</a></p>';      
            $output.='<p>-------------------------------------------------------------</p>';
            ...
            $body = $output; 
            $subject = "Password Recovery - Webex.com";
