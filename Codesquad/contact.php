...
<body>
    ...
    <!-- Page Title Begin -->
    <section class="page-title-bg pt-250 pb-100" data-bg-img="assets/img/section-pattern/page-title1.png">
        <div class="container">
            <div class="row">
                <div class="col-12">
            ...
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <div class="contact-info">
                        <h3>Contact Info</h3>
                        <p>Feel free to get in touch with us <br>through any of these media.</p>

                        <div class="row">
                            <!-- Single Contact Info -->
                            <div class="col-sm-6 col-lg-12 single-contact-info media align-items-center">
                                <div class="image">
                                    <img src="assets/img/icons/location.svg" class="svg" alt="">
                                </div>
                                <div class="media-body">
                                    <h4>Office Location</h4>
                                   <p> 163 Sinari Daranijo Street, Victoria Island Lagos.</p>
                                   <p>12, Onikanga Street, GRA, Ilorin<br> Kwara State.</p>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-lg-12 single-contact-info media align-items-center">
                                <div class="image">
                                    <img src="assets/img/icons/phone.svg" class="svg" alt="">
                                </div>
                                <div class="media-body">
                            ...
                            <div class="col-sm-6 col-lg-12 single-contact-info media align-items-center">
                                <div class="image">
                                    <img src="assets/img/icons/email.svg" class="svg" alt="">
                                </div>
                                <div class="media-body">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="contact-form-wrapper">
                        ...
                        <p>Do you have a question regarding any of our product or do you want to know more about becoming a webex marketer ? send us message and we will get back to you ASAP.</p>

                        <form method="POST" action="sendmail.php" name="contact" class="contact-form">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="company" class="theme-input-style" placeholder="Company Name (Optional)">
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-12">
                                    <button type="submit" name="contact" class="btn"><span>Submit</span></button>
                                </div>
                            </div>
    ...
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3964.734641815496!2d3.4335863147062238!3d6.428127426048262!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x103bf53cb4e73455%3A0xdacbe43a52706828!2s163%20Sinari%20Daranijo%20St%2C%20Victoria%20Island%20106104%2C%20Lagos!5e0!3m2!1sen!2sng!4v1635502343022!5m2!1sen!2sng" width="100%" height="550" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="copyright-text text-center">
                            <span>Copyright &copy; Webexecutives 2021. | All Right Reserved </span>
                        </div>
                    </div>
                </div>
            </div>
